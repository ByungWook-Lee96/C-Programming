...
namespace _040_Operator_Bit
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("a << 1: " + (a << 1)); //0000 0000 0000 0000 0000 0000 0111 1000 
                                                    //=> 왼쪽으로 1시프트 하면 2배로 증가(곱셈연산기)


                             //0000 0000 0000 0000 0000 0000 0001 0100
            int g = 20 >> 2; //0000 0000 0000 0000 0000 0000 0000 0101 => 5
            Console.WriteLine("20 >> 2: " + g);
            Console.WriteLine("20 >> 1: " + (20 >> 1)); //0000 0000 0000 0000 0000 0000 0000 1010  
                                                        //=> 오른쪽으로 1시프트 하면 2로 나눔(나눗셈연산기)
                            //0000 0000 0000 0000 0000 0000 0001 0110
            ...
            //1111 1111 1111 1111 1111 1111 1111 1010 => -6 (CPU에 따라 다름)
            int i = (~b) >> 2;
